...
/**
 * WhatsApp (Baileys) vive en el API Node. En local: `api` en marcha + proxy de Vite o `VITE_API_URL`.
 * En Netlify sin servidor Node público, estas rutas no tendrán backend (404 / error de red).
 *
