-- Fix: la antigüedad no debe basarse solo en fecha_ultima_actualizacion
-- (las importaciones la refrescan y el preview quedaba en 0).
-- Criterio: fecha_resolucion → si no, fecha_nota → si no, fecha_ultima_actualizacion.
